...
import com.example.background.waterColorEffectBitCode;

/**
 * @hide
 */
public class ScriptC_waterColorEffect extends ScriptC {
    private static final String __rs_resource_name = "watercoloreffect";
    // Constructor
    public  ScriptC_waterColorEffect(RenderScript rs) {
        super(rs,
              __rs_resource_name,
              waterColorEffectBitCode.getBitCode32(),
              waterColorEffectBitCode.getBitCode64());
